...
var calculateTotal = (luckyNumber, totalAmount) => {
    var discount = 0;
...
//
var totalBill = parseFloat(prompt("What was the total amount of your bill?"));
alert("Your lucky number is " + luckyNumber + "!" +
    " Instead of paying $" + totalBill.toFixed(2) + ", you will pay $" +
...
( () => {
    ...
    if (enterNumber) {
        ...
        var evenOdd = userNumber % 2 == 0 ? " is even." : " is odd.";
        var posNeg = userNumber < 0 ? "negative." : "positive.";

        if (isNaN(userNumber)) {
            alert("This is not a number!");
        } else {
            alert(userNumber.toString() + evenOdd + " " +
                "The number is " + posNeg + " " +
                "If you add 100, you get " + (userNumber + 100) + "."
            );
        }
    }
})();
